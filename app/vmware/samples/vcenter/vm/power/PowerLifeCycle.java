...
public class PowerLifeCycle extends SamplesAbstractBase {
    ...
    public PowerLifeCycle() {
    }

    public PowerLifeCycle(String vmName, VMConnection conn) {
        super(conn.getServer(), conn.getUsername(), conn.getPassword());
        this.vmName = vmName;
    }
    ...
    public PowerTypes.Info getPowerInfo() {
        return this.vmPowerService.get(vmId);
    }

    public void startVM() {
        System.out.println("# Example: Start the vm");
